    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://webservices/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://webservices/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservices/", "BanqueServicePort"), BanqueService.class, features);
    }
